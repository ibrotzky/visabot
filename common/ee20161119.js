...
{
	/** Function to create the language object for code optimization */
	var language = function()
	{
		 ...
		 */
		speaking: null,
		/**  {number} Grade for the Listening
		 * 
		 * None: 0 to 10
		 * 
		 * CELPIP: 0 to 12

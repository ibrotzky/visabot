...
<header class="dashboard_header">
    <div class="dashboard_header_title">
        <h1 class="icon-user-check">Clientes</h1>
...
<div class="dashboard_content">
    ...
    $Pager = new Pager("dashboard.php?wc=users/customers&page=", "<<", ">>", 5);
    ...
    if (!$Read->getResult()):
        $Pager->ReturnPage();
        echo Erro("<span class='al_center icon-notification'>Ainda não existem CLIENTES cadastrados {$Admin['user_name']}. Comece agora mesmo cadastrando um novo. Ou aguarde novos clientes se cadastrarem!</span>", E_USER_NOTICE);
    else:

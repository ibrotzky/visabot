...
class PagSeguroConfigWrapper
{
     ...
     *
     */
    const PAGSEGURO_TOKEN_PRODUCTION = PAGSEGURO_TOKEN_PRODUCTION;
    /**
     *
     */
    const PAGSEGURO_TOKEN_SANDBOX = PAGSEGURO_TOKEN_SANDBOX;
    /**
     *
     */
    const PAGSEGURO_APP_ID_PRODUCTION = PAGSEGURO_APP_ID_PRODUCTION;
    /**
     *
     */
     ...
     *
     */
    const PAGSEGURO_APP_KEY_PRODUCTION = PAGSEGURO_APP_KEY_PRODUCTION;
    /**
     *
     */
    const PAGSEGURO_APP_KEY_SANDBOX = PAGSEGURO_APP_KEY_SANDBOX;
    /**
     * UTF-8, ISO-8859-1
     */
